...
// methods for controlled operation:
  ...
  void  update     (char *input, unsigned int input_length);
...
// first, some types:
  ...
  typedef char uint1; // assumes char is 1 word long
